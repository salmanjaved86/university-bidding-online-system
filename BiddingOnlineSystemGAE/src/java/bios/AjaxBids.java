...
public class AjaxBids extends ActionSupport implements SessionAware {
    /**
    ...
    /**
     * Method validates the add bid function
     */
    ...
    public String execute() {
        ...
        addActionMessage("Dear" + userId + "You have placed a bid for " + courseCode + " " + sectionCode);
        return "success";
    }
    ...
    private boolean checkExamClash() {
        ...
        List<SuccessfulBid> studentSuccessfulBidList = SuccessfulBidDataManager.getStudentSuccessfulBids(userId);
